...
<div id="bigone">
    ...
    <div id="maoxiangonglue">
        <h1><a href="allmxgonglue.jsp">冒险攻略</a></h1>
        <ul id="mxgl">

        </ul>
    </div>

    <div id="yingxionggonglue">
        <h1><a href="allyxgonglue.jsp">英雄攻略</a></h1>
        <ul id="yxgl">

        </ul>
    </div>

    <div id="xinshougonglue">
        <h1><a href="allxsgonglue.jsp">新手攻略</a></h1>
        <ul id="xsgl">
