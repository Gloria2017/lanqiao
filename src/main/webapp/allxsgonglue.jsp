...
<div id="bigone">
    ...
    <div id="gongluetable">
        <div id="search" >
            <form >
                <input id="selectByInfo3" type= "text" placeholder="请输入你想搜索的攻略名" style="height: 20px;"/>
                <input type="button" onclick="selectBytitleLike3()" value="搜索"/>
            </form>
        </div>
    </div>
    <div id="content">
        <table border="1px" cellspacing="0" id="xstab" >
