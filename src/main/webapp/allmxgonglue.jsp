...
<head>
    ...
    <script type="text/javascript" src="js/hero.js" charset="utf-8"></script>
</head>
<body onload="newshow()">
<div id="headpicture">
...
<div id="bigone">
    ...
    <div id="gongluetable">
        <div id="search" >
        <form >
            <input id="selectByInfo1" type= "text" placeholder="请输入你想搜索的攻略名" style="height: 20px;"/>
            <input type="button" onclick="selectBytitleLike1()" value="搜索"/>
        </form>
    </div>
    </div>
    ...
    <div id="content">
        <table border="1px" cellspacing="0" id="gltab" >
